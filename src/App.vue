<template>
  <div id="app">
    <h1>Tarkov Ammo</h1>
    <div class="grid">
      <BulletSelector :bullets="bullets" @bulletChange="bulletChangeLeft" :bulletToCompare="bulletRight"></BulletSelector>
      <BulletSelector :bullets="bullets" @bulletChange="bulletChangeRight" :bulletToCompare="bulletLeft"></BulletSelector>
    </div>
  </div>
</template>
